...
if (isset($_POST['submit'])) {
	...
	if (!empty($name && $phone && $skill )){
		$insert_query = mysqli_query($con, "INSERT INTO users(name,phone, skill) VALUES('$name', '$phone', '$skill')");
		if ($insert_query > 0) {
          ...
          <div class="row"> 
            <div class="col-md-12">
                <h1 class="page-header text-center">
                  Contacts Manager
                    <small>Quickly access your Business associates</small>
            </div>
            ...
            <form class="form-horizontal" action="" method="POST" >    
                <div class="form-group">
                    <div class="col-md-4 col-md-offset-2">
                        <input type="text" name="name" class="form-control " placeholder="name" value="<?php if (isset($name)) echo $name;?>" auto="off">
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-4 col-md-offset-2">
                        <input type="text" name="skill" class="form-control " placeholder="skill" value="<?php if (isset($skill)) echo $skill;?>">
                    </div>
